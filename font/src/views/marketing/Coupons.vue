<template>
  <div class="invoice" v-loading="fullscreenLoading">
    ...
    <m-table :tableData="tableData" :opreatWidth="110" :tableList="tableList" localName="coupons_table" :otherList="detialDic" :keyword="keyword" :opreat="opreat" :total="total" @pageChange="pageChange"></m-table>
    <el-dialog :title="formTitle" :visible.sync="formVisible">
      <h2 class="dialog-title" slot="title"><i class="iconfont c-blue">&#xe624;</i>{{ formTitle }}</h2>
      <el-form class="dialog-form clearfix" :model="form" ref="form" :rules="rules">
        ...
        <el-form-item label="开始时间：" :label-width="formLabelWidth" prop="begin_time">
          <el-date-picker type="date" :disabled="isEidt" v-model="form.begin_time" placeholder="开始时间" :format="'yyyy-MM-dd HH:mm:ss'" @change="formBeign">
          </el-date-picker>
        </el-form-item>
