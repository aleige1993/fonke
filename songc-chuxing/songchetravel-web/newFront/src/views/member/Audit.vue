<template>
    ...
    <m-table :titleKey="titleKey" :tableData="tableData" labelWidth="130px" :opreatWidth="200" :tableList="tableList" localName="audit_table" :otherList="detialDic" :keyword="keyword" :opreat="opreat" :total="total" @pageChange="pageChange" :add="false"></m-table>
		<!--dialog audit-->
    ...
    methods: {
      ...
      goAudit(idx, itm) {
        ...
        getByIdCard({
          ...
          this.formAudit.birthday = res.data.entity.birthday
          this.formAudit.sex = res.data.entity.gender
        })
      },
      goCancelAudit() {
