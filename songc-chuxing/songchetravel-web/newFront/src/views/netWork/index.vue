<template>
    ...
    <m-table :titleKey="titleKey" :tableData="tableData" :opreatWidth="110" :showOther="false" :tableList="tableList" localName="netWork_table" :keyword="keyword" :opreat="opreat" :total="total" @pageChange="pageChange" :add="roles.add" @add="goAdd"></m-table>
		<!--dialog add-->
...
<script>
	...
	export default {
      ...
      addSave() {
      	var that = this;
      	var url = APIADDRESS + this.optType == "add" ? "/station/station/add" : "/station/station/update";
