<template>
    ...
    <m-table :titleKey="titleKey" :tableData="tableData" :opreatWidth="110" :showOther="false" :tableList="tableList" localName="department_table" :keyword="keyword" :opreat="opreat" :total="total" @pageChange="pageChange" :add="roles.add" @add="goAdd"></m-table>
		<!--dialog add-->
