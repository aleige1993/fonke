<template>
  <div class="companyAccount">
    ...
    <m-table :titleKey="titleKey" :tableData="tableData" :opreatWidth="100" :showOther="false" :tableList="tableList" localName="company_table" :keyword="keyword" :opreat="opreat" :total="total" @pageChange="pageChange" :add="roles.add" @add="add"></m-table>
	  <!-- 弹出框-start -->
		<el-dialog class="ca-dialog" :visible.sync="dialogFormVisible">
			<h2 class="dialog-title" slot="title"><i class="iconfont c-blue" v-html="dialogTitle === '新增公司账户' ? '&#xe684;' : '&#xe654;'"></i>{{dialogTitle}}</h2>
