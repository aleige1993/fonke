<template>
    ...
    <m-table :titleKey="titleKey" :tableData="tableData" :opreatWidth="110" :otherList="otherList" :tableList="tableList" localName="fault_table" :keyword="keyword" :opreat="opreat" :total="total" @pageChange="pageChange" :add="false"></m-table>
		<!--dialog edit-->
