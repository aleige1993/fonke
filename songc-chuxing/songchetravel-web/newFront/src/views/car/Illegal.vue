<template>
    ...
    <m-table :titleKey="titleKey" :tableData="tableData" labelWidth="130px" :opreatWidth="110" :tableList="tableList" localName="illegal_table" :otherList="detialDic" :keyword="keyword" :opreat="opreat" :total="total" @pageChange="pageChange" :add="roles.add" @add="add"></m-table>
		<!--dialog add-->
	...
	export default {
      ...
      const self = this
        ...
        ruleAdd: {
        	...
        	score:[
            { required: true, min: 1, max: 12, type: 'number', message: '最小1分，最大12分', tigger: 'blur' }
          ],
        	fine:[{
        		required: true,
						type: 'number',
